...
class _CreateTeacherScreenState extends State<CreateTeacherScreen> {
  ...
  Future<void> _loadGroups() async {
    try {
      ...
      setState(() =>
          _groupsError = e is ApiException ? e.message : 'Error al cargar grupos');
    }
  }
    ...
    for (final entry in _selected.entries) {
      ...
      for (final b in a.blocks) {
        if (b.day == null || b.start == null || b.end == null) {
          setState(() =>
              _error = 'Completa día y horario en cada bloque de ${a.groupName}');
          return;
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_step == 0 ? 'Nuevo docente · Datos' : 'Nuevo docente · Grupos'),
  ...
  Widget _buildStep2() {
    ...
    return ListView(
      ...
      children: [
        ...
        Text('${_selected.length} grupo(s) seleccionado(s)',
        ...
        ...filtered.map((g) {
          ...
          return Card(
            ...
            child: CheckboxListTile(
              ...
              title: Text('Grupo ${g.name}',
                  style: const TextStyle(
                      fontWeight: FontWeight.w700, color: SofiaColors.ink)),
              subtitle: Text(g.schoolYearName,
                  style: const TextStyle(color: SofiaColors.soft)),
              onChanged: (checked) {
                setState(() {
                  if (checked == true) {
        ...
        if (filtered.isEmpty)
          const Padding(
            ...
            child: Center(
              child: Text('No hay grupos que coincidan.',
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
                labelText: 'Materia', hintText: 'Ej. Matemáticas', isDense: true),
                    ...
                    child: _TimeBox(
                      ...
                      onTap: () async {
                        final t = await showTimePicker(
                            context: context,
                            initialTime: b.start ?? const TimeOfDay(hour: 8, minute: 0));
                  ...
                  Expanded(
                    ...
                    child: _TimeBox(
                      ...
                      onTap: () async {
                        final t = await showTimePicker(
                            context: context,
                            initialTime: b.end ?? const TimeOfDay(hour: 9, minute: 0));
